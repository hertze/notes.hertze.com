  ...
  <body>
      <div id="header">
        ...
        <ul>
        	...
        	<li><a href="/fiktion">Fiktion</a></li>
	...
	<article>
		...
		<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			<div class="<?php if ( is_page()) { echo "page"; } else { echo "post"; } ?>" class="<?php $category = get_the_category(); echo $category[0]->cat_name; ?>" >
